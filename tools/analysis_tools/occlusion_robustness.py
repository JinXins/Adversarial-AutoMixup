...
def parse_args():
    ...
    parser.add_argument('--random_drop', type=float, default=None, help='drop image extend, from 0.0 to 1.0')
    parser.add_argument(
        '--work_dir',
        type=str,
...
def main():
    ...
    if not distributed:
        ...
        if args.random_drop is None:
            ...
            outputs = single_gpu_occlusion_test(model, data_loader, args.random_drop, args.drop_size)
