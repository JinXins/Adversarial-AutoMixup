...
## 🛠 Installation
***💥News! ! !💥***  
***2024-01-18:*** *you can clone Openmixup training **"AdAutoMix"[[ICLR 2024]](https://arxiv.org/abs/2312.11954)***.  
***2023-12-19:*** *We update some analysis tools code such as: Calibration, FGSM* `calibration_fgsm.py` *and Occlusion Robustness* `occlusion_robustness.py` *experiments, also we support a mix augmentation method **"SnapMix"[[AAAI 2021]](https://arxiv.org/abs/2012.04846)***.  
...
&emsp;&emsp;Of course, we're also trying to research how we can use AI to predict and detect diseases, potentially Alzheimer's, Parkinson's, etc., but of course, this is new research for us, so we're still figuring it out.*  
&emsp;&emsp;Email: 158398730@qq.com
