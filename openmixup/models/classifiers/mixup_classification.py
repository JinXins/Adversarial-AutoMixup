...
class MixUpClassification(BaseModel):
    ...
    def __init__(self,
        ...
        self.dynamic_mode = {
            ...
            "automix": self._mixblock, "samix": self._mixblock, "adaptivemix":self._mixblock,
    ...
    def forward_mix(self, img, gt_label, remove_idx=-1):
        ...
        # applying hand-crafted sample mixup methods
            ...
            if cur_mode in ["mixup", "cutmix", "saliencymix", "smoothmix",]:
                ...
                img, gt_label, cur_alpha = self.static_mode[cur_mode](img, gt_label, **mix_args)
            elif cur_mode == "recursivemix":
                img, gt_label, boxes = self.static_mode[cur_mode](img, gt_label, **mix_args)
            else:
    ...
    def simple_test(self, img):
        ...
        keys = ['head{}'.format(i) for i in range(0,1)]
