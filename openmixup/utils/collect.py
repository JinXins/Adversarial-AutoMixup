...
def occlusion_forward_collect(func, data_loader, length, random_drop, drop_size):
    ...
    # MEAN, STD = [-mean / std for mean, std in zip([0.4914, 0.4822, 0.4465], [0.2023, 0.1994, 0.201])], [1 / std for std
    #                                                                                                     in
    #                                                                                                     [0.2023, 0.1994,
    #                                                                                                      0.201]]
    ...
    print("patch size is {}\n total tokens: {}\n occlusion ratio is {}% and masked tokens are {}"
          .format(patch, patch_num, random_drop*100, mask_num))
...
def fgsm_nondist_forward_collect(func, data_loader, length, head):
